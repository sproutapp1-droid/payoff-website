export const SITE_URL = 'https://www.payoffdebtplanner.com';
...
export const APP_DOWNLOAD_URL = STORE_LINKS.appStore;
export const APP_CTA_TEXT = 'Download Free';
export const APP_CTA_TEXT_ALT = 'Get the App';
