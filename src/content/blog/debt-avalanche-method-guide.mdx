...
**The debt avalanche method is a debt repayment strategy where you pay off debts in order from highest interest rate to lowest, minimising total interest paid. You make minimum payments on all debts except the highest-APR one, then direct every extra pound or dollar toward that debt. When it's eliminated, you roll its payment into the next-highest rate. The avalanche method is the mathematically optimal approach — it saves the most money on interest of any debt payoff strategy.**
